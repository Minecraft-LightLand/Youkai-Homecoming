...
public class FeedReimuTrigger extends SimpleCriterionTrigger<FeedReimuTrigger.TriggerInstance> {
   ...
   public static FeedReimuTrigger.TriggerInstance usedItem(ItemLike pItem) {
      return new FeedReimuTrigger.TriggerInstance(ContextAwarePredicate.ANY, new ItemPredicate((TagKey<Item>)null, ImmutableSet.of(pItem.asItem()), MinMaxBounds.Ints.ANY, MinMaxBounds.Ints.ANY, EnchantmentPredicate.NONE, EnchantmentPredicate.NONE, (Potion)null, NbtPredicate.ANY));
   }
