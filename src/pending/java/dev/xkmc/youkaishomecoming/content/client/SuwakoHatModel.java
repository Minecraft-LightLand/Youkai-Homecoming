...
public class SuwakoHatModel {
	public static final ModelLayerLocation SUWAKO = new ModelLayerLocation(YoukaisHomecoming.loc("suwako_hat"), "main");
	public static final ModelLayerLocation STRAW = new ModelLayerLocation(YoukaisHomecoming.loc("straw_hat"), "main");
