...
import dev.xkmc.youkaihomecoming.content.block.food.EmptySaucerBlock;
import dev.xkmc.youkaihomecoming.content.block.food.FleshFeastBlock;
import dev.xkmc.youkaihomecoming.content.item.food.BloodBottleItem;
import dev.xkmc.youkaihomecoming.content.item.food.FleshBlockItem;
import dev.xkmc.youkaihomecoming.content.item.food.FleshSimpleItem;
import dev.xkmc.youkaihomecoming.content.item.curio.SuwakoHatItem;
