...
public enum YHLangData {
	...
	OBTAIN_FLESH("obtain_flesh", "Kill human mobs with knife while in youkai status", 0, ChatFormatting.GRAY),
	OBTAIN_BLOOD("obtain_blood", "Kill human mobs with knife and have glass bottle in off hand while in youkai status", 0, ChatFormatting.GRAY),
	...
	USAGE_DANMAKU("usage_danmaku", "While in touhou status, or equip touhou hats, you can shoot danmaku", 0, ChatFormatting.GRAY),

	USAGE_STRAW_HAT("usage_straw_hat", "While in touhou status, you can equip it on frogs to allow them to eat raiders", 0, ChatFormatting.GRAY),
	...
	USAGE_RUMIA_HAIRBAND("usage_rumia_hairband", "Transforms you toward youaki. Drops heads when killing mobs. Flesh and blood drops no longer require knife (bonus when still using knife).", 0, ChatFormatting.GRAY),
	...
	USAGE_CIRNO_HAIRBAND("usage_cirno_hairband", "Makes you a Fairy. Your magic damage freezes target (and frogs). Allows using Light Blue danmaku without consumption.", 0, ChatFormatting.GRAY),
	USAGE_FAIRY_WINGS("usage_fairy_wings", "When you are a Fairy, enables creative flight.", 0, ChatFormatting.GRAY),
