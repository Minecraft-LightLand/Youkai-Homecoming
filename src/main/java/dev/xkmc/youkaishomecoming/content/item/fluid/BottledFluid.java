...
public class BottledFluid<T extends SakeBottleItem> implements IYHFluidHolder, ItemLike {
	...
	public static final ResourceLocation SOLID_FLOW = YoukaisHomecoming.loc("block/fluid/water_flow");
	public static final ResourceLocation SOLID_STILL = YoukaisHomecoming.loc("block/fluid/water_still");
