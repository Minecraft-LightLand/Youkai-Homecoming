...
public class WildCoffeaBlock extends DoublePlantBlock {
	...
	public static void buildWildLoot(RegistrateBlockLootTables pvd, WildCoffeaBlock block, CoffeeCrops crop) {
	...
	public static void buildWildModel(DataGenContext<Block, WildCoffeaBlock> ctx, RegistrateBlockstateProvider pvd, CoffeeCrops crop) {
