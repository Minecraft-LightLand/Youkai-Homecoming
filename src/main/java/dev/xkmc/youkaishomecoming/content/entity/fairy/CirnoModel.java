...
public class CirnoModel<T extends CirnoEntity> extends HierarchicalModel<T> {
	...
	public static final ModelLayerLocation HAT_LOCATION = new ModelLayerLocation(YoukaisHomecoming.loc("cirno_nat"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rightArm = partdefinition.addOrReplaceChild("rightArm", CubeListBuilder.create().texOffs(50, 0).addBox(-5.0F, -18.0F, -1.5F, 2.0F, 9.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(26, 40).addBox(-5.55F, -18.5F, -2.0F, 3.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition leftArm = partdefinition.addOrReplaceChild("leftArm", CubeListBuilder.create().texOffs(49, 49).addBox(3.0F, -18.0F, -1.5F, 2.0F, 9.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(12, 40).addBox(2.45F, -18.5F, -2.0F, 3.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition rightLeg = partdefinition.addOrReplaceChild("rightLeg", CubeListBuilder.create().texOffs(0, 44).addBox(-2.85F, -9.0F, -1.5F, 3.0F, 9.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(0, 30).addBox(-3.35F, -9.5F, -2.0F, 4.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.15F, 24.0F, 0.0F));

		PartDefinition leftLeg = partdefinition.addOrReplaceChild("leftLeg", CubeListBuilder.create().texOffs(40, 40).addBox(0.15F, -9.0F, -1.5F, 3.0F, 9.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(28, 12).addBox(-0.35F, -9.5F, -2.0F, 4.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.15F, 24.0F, 0.0F));
