...
@SerialClass
public class UnorderedCuisineTableRecipe extends CuisineTableRecipe<UnorderedCuisineTableRecipe> {
	...
	public UnorderedCuisineTableRecipe(ResourceLocation id) {
		super(id, YHBlocks.TABLE_UNORDER.get());
	}
